...
Um einen Überblick über die verschiedenen Datensätze zu gewinnen, wurden verschiedene Observablen (Jet-Anzahl, Transversalimpuls des Elektrons und des $W$-Bosons) histogrammiert, wie in Abbildung \korr{REF} gezeigt ist.
\begin{sidewaysfigure}
	\centering
	\begin{subfigure}{.49\textwidth}
		\includegraphics[width=\textwidth]{./data/root/wmass/exercise1/ATLAS_njet.pdf}
	\end{subfigure}
	\begin{subfigure}{.49\textwidth}
		\includegraphics[width=\textwidth]{./data/root/wmass/exercise1/MC_njet.pdf}
	\end{subfigure}
	\begin{subfigure}{.49\textwidth}
		\includegraphics[width=\textwidth]{./data/root/wmass/exercise1/ATLAS_el_pt.pdf}
	\end{subfigure}
	\begin{subfigure}{.49\textwidth}
		\includegraphics[width=\textwidth]{./data/root/wmass/exercise1/MC_el_pt.pdf}
	\end{subfigure}
\end{sidewaysfigure}
\begin{sidewaysfigure}
	\centering
