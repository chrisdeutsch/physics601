...
% ZUSAMMENFASSUNG
\begin{abstract}
\noindent In diesem Praktikumsversuch sollen Daten des ATLAS Detektor am LHC untersucht werden.
...
\begin{figure}[h]
	...
	\begin{overpic}[width=0.9\textwidth,tics=10]{./figures/wmass/comparison}
		...
		\put (-4,29) {\rotatebox{90}{Ereignisse}}
	\end{overpic}
	\vspace*{1.2em}
...
In dem Versuch konnten einige Einblicke in die Arbeit mit Daten des ATLAS Detektors gewonnen werden.
Insbesondere der Umgang mit der Datenanalyse-Software ROOT stellte eine neue Erfahrung dar.
Durch die Betrachtung ausgewählter Ereignisse mit Atlantis konnte ein gutes Verständnis für die unterschiedlichen Elemente des ATLAS Detektors aufgebaut werden.
Die Kalibration der elektromagnetischen Kalorimeter gelang gut und stellte eine gute Basis für die anschließende Massenbestimmung des W-Bosons dar.
