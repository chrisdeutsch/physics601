...
Bei den betrachteten Ereignissen können mithilfe der Ereignisanzeige \textit{Atlantis} die Myonenparameter (Impuls~$p$, transversaler Impuls~$p_\mathrm{T}$, Pseudorapidität~$\eta$, \dots) der Myonen jeweils im inneren Detektor und im Myonensystem abgefragt werden.
