...
\begin{figure}[htbp]
	...
	\begin{overpic}[width=\textwidth,tics=10]{./data/root/calibration/new/calibrated.pdf}
		...
		\put (1,29) {\rotatebox{90}{Ereignisse}}
	\end{overpic}
	\caption{Invariante Leptonen-Masse nach Kalibration der Energiemessung.}
	\label{fig:final_calibration}
\end{figure}

\section{Messung der W-Boson-Masse}

Mit der in Aufgabe 2 gefundenen Kalibration der elektromagnetischen Kalorimeter kann nun die Masse des W-Bosons möglichst genau bestimmt werden.
Dazu wird die Kalibration auf die zu verwendenden Messdaten angewendet und ein Fit-Objekt wie in Aufgabe 2 in ROOT geladen, um die Auswertung vorzunehmen.
...
Im Anschluss wird das Spektrum des Transversalimpulses des $W$-Bosons in Abhängigkeit von der Anzahl Jets betrachtet, um \korr{wofür genau?} Die Darstellung für Ereignisse ohne Jets ist in Abbildung \ref{fig:njet0} gezeigt, alle weiteren folgen in Abbildung \ref{fig:njet1-4}.
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{./data/root/wmass/exercise2/njet0}
	\caption{Transversalimpuls des $W$-Bosons für Ereignisse ohne Jets.}
	\label{fig:njet0}
\end{figure}
\begin{sidewaysfigure}
	\centering
	...
	\label{fig:njet1-4}
\end{sidewaysfigure}
\korr{"Wie unterscheiden sie sich und warum?"}
