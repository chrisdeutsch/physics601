...
\begin{itemize}
	\item Bei der Impulsdifferenz klarmachen dass der Betrag genutzt wurde.
	\item Bethe-Bloch, it's a MIP, vermutlich unterhalb kritischer Energie
	\item $\eta$ Abhängigkeit, ATLAS bild?
	\item Energieverlust ist statistisch -> Landau-Verteilung -> einzelne Messpunkte wenig Aussage -> folgen einer Distribution.
\end{itemize}
