...
\begin{align}
	E(x) = E_0 \, \mathrm{e}^{-\frac{x}{X_0}}
	\label{eq:radiation_length}
\end{align}
mit der Energie~$E(x)$ eines Elektrons nach der Strecke~$x$ definiert ist.
In Abbildung \korr{REF} sieht man, dass das Materialbudget bei kleinen Pseudorapiditäten für die Strahlröhre und Pixeldetektoren in der Größenordnung von \num{0.1} bis $\num{0.2} \, \mathrm{X}_0$ liegt.
Dies entspricht gemäß Gleichung \eqref{eq:radiation_length} einer Korrektur von etwa
\begin{align*}
	\mathrm{e}^{\num{0.1}} \approx \SI{110}{\percent} \qquad \text{bis} \qquad \mathrm{e}^{\num{0.2}} \approx \SI{120}{\percent}
\end{align*}
