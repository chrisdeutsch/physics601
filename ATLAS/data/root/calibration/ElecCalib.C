		 ...
		 double phi, double etiso, double eoverp, double mindrjet)
{
  ...
  // eta calibration for 0 < energy < 50
  if (energy < 50.0) {
      if (fabs(eta) >= 0.0 && fabs(eta) < 0.5) energy *= 91.19 / 88.83;
      if (fabs(eta) >= 0.5 && fabs(eta) < 1.0) energy *= 91.19 / 86.85;
      if (fabs(eta) >= 1.0 && fabs(eta) < 1.5) energy *= 91.19 / 86.15;
      if (fabs(eta) >= 1.5 && fabs(eta) < 2.0) energy *= 91.19 / 83.88;
  } else if (energy < 100.0) {
      if (fabs(eta) >= 0.0 && fabs(eta) < 0.5) energy *= 91.19 / 93.16;
      if (fabs(eta) >= 0.5 && fabs(eta) < 1.0) energy *= 91.19 / 90.07;
      if (fabs(eta) >= 1.0 && fabs(eta) < 1.5) energy *= 91.19 / 86.6;
      if (fabs(eta) >= 1.5 && fabs(eta) < 2.0) energy *= 91.19 / 85.48;
      if (fabs(eta) >= 2.0 && fabs(eta) < 2.5) energy *= 91.19 / 83.2;
  } else {
      if (fabs(eta) >= 0.0 && fabs(eta) < 1.5) energy *= 91.19 / 88.26;
      if (fabs(eta) >= 1.5 && fabs(eta) < 1.75) energy *= 91.19 / 82.54;
      if (fabs(eta) >= 1.75 && fabs(eta) < 2.0) energy *= 91.19 / 81.76;
      if (fabs(eta) >= 2.0 && fabs(eta) < 2.5) energy *= 91.19 / 78.87;
  }
  
  // second iteration phi
  ...
  // third iteration eta
  if (fabs(eta) > 0.0 && fabs(eta) < 0.75) energy *= 91.19 / 92.06;
  if (fabs(eta) > 0.75 && fabs(eta) < 1.5) energy *= 91.19 / 91.16;
  if (fabs(eta) > 1.5 && fabs(eta) < 2.0) energy *= 91.19 / 90.46;
  if (fabs(eta) > 2.0 && fabs(eta) < 2.5) energy *= 91.19 / 90.03;
