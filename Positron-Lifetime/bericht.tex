...
\end{align}
mit den Bruchteilen der gebundenen bzw. freien Positronen $f$ und den Lebensdauern $1/\tau = \lambda$.
Nimmt man weiterhin an, das $\xi_\mathrm{b}=0$ gilt, was einer starken Bindung der Positronen an die Leerstellen entspricht, kann man schreiben
\begin{align}
	\bar\tau=\frac{\lambda_\mathrm{b}+\mu_\mathrm{b}c_\mathrm{v}(T)}{\lambda_\mathrm{b}\lambda_\mathrm{f}+\mu_\mathrm{b}\lambda_\mathrm{b}c_\mathrm{v}(T)}\quad\text{,}
\end{align}
...
\begin{sidewaystable}
	...
	\begin{subtable}{\textwidth}
		...
		\caption{Umrechnung der Zeiten mithilfe der Zeitkalibration und Bestimmung der mittleren Lebenzeit~$\bar{\tau}$.}
	\end{subtable}
\end{sidewaystable}
