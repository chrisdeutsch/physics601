...
Als Positronenquelle wird in diesem Versuch Natrium (\isotope[22]{Na}) verwendet, welches durch radioaktiven $\beta^+$-Zerfall in einen angeregten Zustand von Neon (\isotope[22]{Ne}) zerfällt, der eine sehr kurze Lebensdauer hat und unter Emission eines Photons mit \SI{1275}{keV} in den Grundzustand übergeht.
