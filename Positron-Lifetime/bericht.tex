...
\begin{abstract}
\noindent
In dem vorliegenden Versuch soll die Lebensdauer von Positronen in freiem beziehungsweise gebundenem Zustand in Metallen und Isolatoren untersucht und die Leerstellenenthalpie für die verwendete Indium Probe bestimmt werden.
\end{abstract}
...
In diesem Praktikumsversuch wird die Lebensdauer von Positronen untersucht.
Dazu wird eine metallische Probe (Indium) sowie ein Isolator (Acrylglas) verwendet, in denen die Teilchen sowohl in freiem als auch gebundenen Zustand auftreten können.
Durch Annihilation mit einem Elektron entstehen Photonen, die zur Zeitmessung genutzt werden.
Da die Lebensdauern der beiden Zustände nicht gleich sind, kann die Lebensdauermessung zur Untersuchung von Kristallen genutzt werden, insbesondere zur Untersuchung von Leerstellen, da Positronen dort eingefangen werden und somit der gebundene Zustand gebildet wird.
