...
Als Positronenquelle wird in diesem Versuch das Natrium-Isotop \isotope[22]{Na} verwendet, welches durch $\beta^+$-Zerfall in einen angeregten Zustand von Neon $\left(\isotope[22]{Ne}\right)$ zerfällt, der eine sehr kurze Lebensdauer hat und unter Emission eines Photons mit \SI{1275}{keV} in den Grundzustand übergeht.
