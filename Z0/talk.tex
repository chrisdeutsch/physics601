...
\begin{frame}{Introduction}
		\begin{itemize}
			\item Elementary particles have characteristic mass and decay width
			\item Are detected by their interactions and/or decay products
			\item Characteristic Breit-Wigner resonance at $\sqrt{s}=m_\mathrm{particle}$
			\item Measure properties of heavy vector boson $\mathrm{Z}^0$ in $e^+e^-$ collisions
			\item Determine parameters of elementary particle physics: Weinberg angle, lepton universality, number of light neutrino generations
...
\begin{frame}{Theoretical Background}
	...
	\begin{itemize}
		...
		\item $A_\mathrm{FB}$ can be approximated to be $3\left(\frac{v_\ell}{a_\ell}\right)^2$ for energies near the resonance ($v_\ell$, $a_\ell$ weak couplings)
...
\begin{frame}{$\mathrm{Z}^0$ Boson}
	\begin{itemize}
		\item Mass: \SI{91.2}{GeV}
		\item Decay width: \SI{2.5}{GeV}
...
\begin{frame}{Part I: Analysis of Event Displays}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Looking at event displays with software \texttt{GROPE}
