...
\begin{frame}{Preliminary Cut Selections}
	...
	\end{center}
	\begin{itemize}
		\item Verify cuts by looking at test sample and comparing event type found by cuts and event type determined by eye \item All but one event from test sample identified correctly
