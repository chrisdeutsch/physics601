...
\begin{frame}{Analysis of OPAL Data}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{align*}
				\sigma_i = \frac{N_i}{\int \mathcal{L} \, \mathrm{d}t} + \underbrace{\mathrm{corr}_i(\sqrt{s})}_{\substack{\text{correction for} \\ \text{higher order} \\ \text{processes}}} \qquad i \in \left\{ \mathrm{e}, \mathrm{\mu}, \mathrm{\tau}, \mathrm{q} \right\}
			\end{align*}
...
\begin{frame}{Cross Section \& Breit-Wigner Fit}
	\centering
	\includegraphics[height=0.9\textheight]{./figures/cross_sections.pdf}
\end{frame}
