...
\end{align*}
with respect to the fit parameters~$\Theta$, where the measured values are given by the tuple $(x_i, y_i)$ with standard deviation $\sigma_i$ (in $y$-direction) and the fit hypothesis $f$ that depends on the parameters~$\Theta$.
