...
Sources:
\begin{itemize}
	\item unknown precut: assumption affects $s$ and $t$ channel the same -- probably higher cuts in $t$-channel due to small scattering angle leads to non-reconstructible events
	
	\item systematic error in angle cut for electrons
	
	\item systematic errors due to differences in the MC-data
	
	\item some systematic error in grouping of LEP energies
	
	\item systematic errors in the detector reconstruction -- missing energy in calo etc. this generally corrected by mc stuff
\end{itemize}
