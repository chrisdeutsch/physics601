...
Event number \num{13556} in run \num{4353} has been misinterpreted as a $\tau$ event although it is a two-photon reaction.
This is due to the small momentum measured in \texttt{Ctrk(Sump)} since the photons leave no charged track.
\begin{sidewaystable}
	\centering
