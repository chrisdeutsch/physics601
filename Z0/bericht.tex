...
\end{align*}
The fitting of the Breit-Wigner distribution was done using a non-linear least squares algorithm and the plots of the calculated cross sections as well as the fitted distributions is displayed 
