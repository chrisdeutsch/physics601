...
\begin{align*}
	&w_i = \frac{1}{\Delta \bar{x}_i^2} \, \text{.}
\end{align*}
...
In addition one can calculate the ratio of the hadronic and leptonic peak cross section
\begin{align*}
	...
	&= \num{6.955 +- 0.083}
\end{align*}
using the previously calculated decay widths and peak cross sections.
Comparing these values with the ratio as calculated using partial widths given in \cite{pdg} neglecting any error correlations
\begin{align*}
	\left(\frac{\Gamma_\mathrm{hadrons}}{3\Gamma_\ell}\right)^\mathrm{PDG} = \num{6.924 +- 0.011}
\end{align*}
also shows a good agreement within the errors.
