...
\subsection{Separating $s$- and $t$-Channel of Electron Final States}
...
\begin{align*}
	&\Delta n_i^2 = \sum_k \left[ N_k^2 \cdot \Delta E_{ik}^2 + E_{ik}^2 \cdot \Delta N_k^2 \right]
\end{align*}

\subsection{Determination of the Differential Cross Sections}
...
\subsection{Determination of the Forward-Backward Asymmetry using Muons}
...
\subsection{Fitting Resonance Curves}
\begin{align*}
...
\subsection{Calculation of the Partial Widths}
...
\subsection{Number of Light Neutrino Generations}
