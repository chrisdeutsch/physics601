...
Knowing that each of the datasets have been simulated with \num{100000} events the efficiency of the event selection using cuts can be evaluated.
 ...
 \begin{align*}
 	&E_{ij} = \frac{n_{ij}}{n_i^\mathrm{tot}} \quad \text{with} \quad i,j \in \{ \mathrm{e}, \mathrm{\mu}, \mathrm{\tau}, \mathrm{q} \} \\
 	&n_{ij} \text{: number of $j$ identified as $i$}
 \end{align*}
...
\begin{align*}
	&\Delta n = \sqrt{N \cdot \left[ \frac{n}{N} - \left( \frac{n}{N} \right)^2 \right]} \\
