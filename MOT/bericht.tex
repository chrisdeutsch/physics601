...
\begin{table}[h]
	...
	\caption{Transmittierte Leistung des Strahls~$P$ in Abhängigkeit der Klingenposition~$x$ zur Bestimmung des Strahlradius~$w$.}
...
\end{figure}
Durch die Anpassung wurde demnach der Strahlradius~$w$ (Radius bei dem die Intensität auf $\sfrac{1}{e^2}$ abgefallen ist) zu \SI{2.826 +- 0.089}{mm} bestimmt und kann folglich für die Auswertung verwendet werden.
