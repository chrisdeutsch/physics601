...
\begin{figure}[htb]
	\centering
	\includegraphics[width=.65\textwidth]{./figures/theory/schema}
	\caption{Niveauschema von \isotope[85]{Rb} (aus \cite{script}).}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Transmissionsspektrum des Teststrahls in der Sättigungsspektroskopie. Aufgrund des Dopplereffekts ist eine Senke um \SI{0}{MHz} zu beobachten, in der das dopplerfreie Maximum des betrachteten Übergangs (Lamb-Dip) liegt. \korr{Quelle: nach bla}}
...
Anschließend wird der Scan-Bereich des Kühllasers auf die Umgebung der Kühlübergänge eingestellt und mithilfe des Oszilloskops kann sowohl die Rb-Spektroskopie sowie das Fluoreszenzsignal der Photodiode dargestellt werden.
...
Dies kann darauf zurückzuführen sein, dass für der theoretische Wert~$\delta_\mathrm{opt.}$ nur unter idealisierten Bedingungen gilt, welche in diesem Experiment nicht vollständig erfüllt werden können.
